function smallHome(){
    ...
    <div><img class="borderRadius" src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcTRdJvoCzJ9s1wcF7GVW48tmjNMIrmAlsrVcv568KOIF3RWP96q" alt="">
        <p>History</p>
    </div>
</div>`
}
...
function bigHome(){
    return `<div id="bMenuBar">
    <div id="bHome" class = "a">
        <img class="borderRadius" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYBhvFKR4DhrLlZJDu7Q4rE7RKCYEOmYAwZg&usqp=CAU" alt="">
        <p>Home</p>
    </div>
    <div id="bExplore" class = "a">
        <img class="borderRadius" src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcQPosmyKMCJgFjQivp9ONln2k3c5brUiMeZMxbxs3Kqvow7cRug" alt="">
        <p>Explore</p>
    </div>
    <div id="bSubscripe" class = "a">
    ...
    <hr>
    <p class = "b">Sign in to like videos, comment and subscribe</p>
    <div>
        <div class="signIn" id = "signIn1">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR1sSuGtuCD4wyXKoGfIg5vGb2hCfjGLFTMOoB6Hh5dsXSIkwHBRxt1mpfeiI2Hk1h1IKQ&usqp=CAU" alt="">
            <p>SIGN IN</p>
        </div>
    </div>
</div>`;
